      ...
      <aside className="flex flex-col border-r bg-background" >
        ...
        <nav className="flex-1 px-4 py-6" >
          <ul className="grid gap-1" >
            ...
            <li >
              <Link to="/credentials" className={`flex items-cente gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors hover:bg-muted hover:text-foreground
                ${isActive("/credentials") ? "bg-blue-500 text-white" : "hover:bg-muted hover:text-foreground"}
                `} >
