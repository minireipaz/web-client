      ...
      <aside className="flex flex-col border-r bg-background" >
        ...
        <nav className="flex-1 px-4 py-6" >
          <ul className="grid gap-1" >
            <li >
              <Link to="/dashboard" className={`flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors
            ...
            <li >
              <Link to="/workflows" className={`flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors
            ...
            <li >
              <Link to="/settings" className={`flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors
