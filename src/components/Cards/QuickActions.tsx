...
export const QuickActions = memo(function QuickActions() {
  ...
  async function newWorkflow(
    ...
    try {
      ...
      const [ok, uriFrontend] = getUriFrontend(`/api/v1/workflows`);
      if (!ok) {
          ...
          <div className="flex flex-col gap-y-8 mt-1 mb-1">
            ...
            <div className=" flex flex-col gap-y-1 ">
              ...
              <div className="dropdown bootstrap-select form-control">
                <Select
                  id="create_workflow_select_folder_id"
                  className="w-full"
                  title="Select Folder"
                >
              ...
              <p className="text-black text-xs m-b-0 m-t-5 p-t-1">
                Select the folder or subfolder where you want to create the
                workflow.
              </p>
            </div>
          </div>
